...
echo "     <td>  <button class='btn-sm btn-warning'  onclick='MostrarProveedor(\"".$MostrarProveedor[$i] -> getIDProveedor()."\")' data-bs-toggle='modal' data-bs-target='#ModalModificarProveedor'> Modificar </button> </td>";
